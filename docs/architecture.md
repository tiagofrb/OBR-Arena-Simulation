...
| Construtores | `js/constructors/TileConstructor.js`, `ObjectConstructor.js` | UI/paint tile e objeto |
...
A lógica do editor, shell, simulação, paint e construtores de **ladrilho/objeto** estão extraídos.
Ainda em `main.js`: construtor de robô (fase 6) e orquestração residual.
...
- `main.js` ainda é grande (~2,0k linhas); fases 0–5 concluídas; extração segue `docs/modularization-plan.md`.

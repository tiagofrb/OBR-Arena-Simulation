...
- Fase 0–3 da modularização (`docs/modularization-plan.md`):
  ...
  - `js/constructors/TileConstructor.js`, `ObjectConstructor.js`, `RobotConstructor.js`
  - `js/core/session.js` (`createSessionState`, `createCameraState`)
  - `EditorDragDrop.wireArenaDragDrop`
...
### Changed
- `main.js` é bootstrap + wrappers; lógica nas pastas `app/`, `editor/`, `sim/`, `constructors/`, `core/`
